...
# Mundo 12 — Coquimbo: Valles de Coquimbo.
# Mecánica: túnel de degú para atajos subterráneos.

@onready var player: Node = $Firipu
@onready var hud: Node = $HUD
@onready var medal_area: Area3D = $MedalArea
@onready var boss: Node = $ChinchillaRobot
...
func _ready() -> void:
	...
	_start_world_flow()
	print("Firipu Adventure — Coquimbo: Valles iniciado")
...
func _start_world_flow() -> void:
	...
	if hud.has_method("show_message"):
		hud.show_message("Coquimbo: usa túneles de degú para atajos, registra 4 especies y enfrenta a la Chinchilla Robot.")
	print("FLOW_START Mundo 12 Coquimbo")

func _on_start_requested() -> void:
	gameplay_started = true
	if player.has_method("set_input_locked"):
		player.set_input_locked(false)
	print("FLOW_GAMEPLAY_START Mundo 12 Coquimbo")
...
func _on_exit_requested() -> void:
	print("FLOW_EXIT_REQUESTED Mundo 12 Coquimbo")
	get_tree().quit(0)
...
func _on_prototype_completed() -> void:
	...
	if global_progress != null:
		global_progress.complete_world("coquimbo")
		global_progress.force_save()
	print("FLOW_VICTORY Mundo 12 Coquimbo")
	_on_save_requested()
...
func _on_boss_defeated() -> void:
	print("FLOW_BOSS_DEFEATED Mundo 12 Coquimbo")
	if hud.has_method("show_message"):
		hud.show_message("¡Chinchilla Robot calmada! Los valles recuperan su silencio. Toma la medalla.")
