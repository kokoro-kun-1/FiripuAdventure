...
# Mundo 13 — Atacama: Desierto Florido de Atacama.
# Mecánica: floración temporal de plataformas.

@onready var player: Node = $Firipu
@onready var hud: Node = $HUD
@onready var medal_area: Area3D = $MedalArea
@onready var boss: Node = $VaquitaRobot
...
func _ready() -> void:
	...
	_start_world_flow()
	print("Firipu Adventure — Atacama: Desierto Florido iniciado")
...
func _start_world_flow() -> void:
	...
	if hud.has_method("show_message"):
		hud.show_message("Atacama: activa floración de plataformas, registra 4 especies y enfrenta a la Vaquita Robot.")
	print("FLOW_START Mundo 13 Atacama")

func _on_start_requested() -> void:
	gameplay_started = true
	if player.has_method("set_input_locked"):
		player.set_input_locked(false)
	print("FLOW_GAMEPLAY_START Mundo 13 Atacama")
...
func _on_exit_requested() -> void:
	print("FLOW_EXIT_REQUESTED Mundo 13 Atacama")
	get_tree().quit(0)
...
func _on_prototype_completed() -> void:
	...
	if global_progress != null:
		global_progress.complete_world("atacama")
		global_progress.force_save()
	print("FLOW_VICTORY Mundo 13 Atacama")
	_on_save_requested()
...
func _on_boss_defeated() -> void:
	print("FLOW_BOSS_DEFEATED Mundo 13 Atacama")
	if hud.has_method("show_message"):
		hud.show_message("¡Vaquita Robot calmada! El desierto florece en paz. Toma la medalla.")
