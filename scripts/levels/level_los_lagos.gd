...
# Mundo 5 — Los Lagos: Lagos, Volcanes e Islas.
# Reutiliza el flujo del Biobío/Ñuble/Araucanía/Los Ríos: 4 especies, jefe robot, medalla.
# Mecánica regional propia: balsa natural para cruzar lagos.

@onready var player: Node = $Firipu
@onready var hud: Node = $HUD
@onready var medal_area: Area3D = $MedalArea
@onready var boss: Node = $HuillinRobot
...
func _ready() -> void:
	...
	_start_world_flow()
	print("Firipu Adventure — Los Lagos: Lagos, Volcanes e Islas iniciado")
...
func _start_world_flow() -> void:
	...
	if hud.has_method("show_message"):
		hud.show_message("Los Lagos: usa balsas naturales para cruzar islas, registra 4 especies y enfrenta al Huillín Robot.")
	print("FLOW_START Mundo 5 Los Lagos")

func _on_start_requested() -> void:
	gameplay_started = true
	if player.has_method("set_input_locked"):
		player.set_input_locked(false)
	print("FLOW_GAMEPLAY_START Mundo 5 Los Lagos")
...
func _on_exit_requested() -> void:
	print("FLOW_EXIT_REQUESTED Mundo 5 Los Lagos")
	get_tree().quit(0)
...
func _on_prototype_completed() -> void:
	...
	if global_progress != null:
		global_progress.complete_world("los_lagos")
		global_progress.force_save()
	print("FLOW_VICTORY Mundo 5 Los Lagos")
	_on_save_requested()
...
func _on_boss_defeated() -> void:
	print("FLOW_BOSS_DEFEATED Mundo 5 Los Lagos")
	if hud.has_method("show_message"):
		hud.show_message("¡Huillín Robot reparado! Los Lagos recuperan su paz. Toma la medalla.")
