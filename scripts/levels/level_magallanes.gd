...
# Mundo 7 — Magallanes: Hielo Austral de Magallanes.
# Reutiliza el flujo: 4 especies, jefe robot, medalla.
# Mecánica regional propia: botas de hielo antideslizantes.

@onready var player: Node = $Firipu
@onready var hud: Node = $HUD
@onready var medal_area: Area3D = $MedalArea
@onready var boss: Node = $PenguinRobot
...
func _ready() -> void:
	...
	_start_world_flow()
	print("Firipu Adventure — Magallanes: Hielo Austral iniciado")
...
func _start_world_flow() -> void:
	...
	if hud.has_method("show_message"):
		hud.show_message("Magallanes: usa botas de hielo para cruzar superficies heladas, registra 4 especies y enfrenta al Pingüino Robot.")
	print("FLOW_START Mundo 7 Magallanes")

func _on_start_requested() -> void:
	gameplay_started = true
	if player.has_method("set_input_locked"):
		player.set_input_locked(false)
	print("FLOW_GAMEPLAY_START Mundo 7 Magallanes")
...
func _on_exit_requested() -> void:
	print("FLOW_EXIT_REQUESTED Mundo 7 Magallanes")
	get_tree().quit(0)
...
func _on_prototype_completed() -> void:
	...
	if global_progress != null:
		global_progress.complete_world("magallanes")
		global_progress.force_save()
	print("FLOW_VICTORY Mundo 7 Magallanes")
	_on_save_requested()
...
func _on_boss_defeated() -> void:
	print("FLOW_BOSS_DEFEATED Mundo 7 Magallanes")
	if hud.has_method("show_message"):
		hud.show_message("¡Pingüino Robot detenido! El Austral está a salvo. Toma la medalla.")
