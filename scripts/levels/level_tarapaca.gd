...
# Mundo 15 — Tarapacá: Espejismos de Tarapacá.
# Mecánica: cristal anti-espejismo (distinguir plataformas reales de ilusiones).

@onready var player: Node = $Firipu
@onready var hud: Node = $HUD
@onready var medal_area: Area3D = $MedalArea
@onready var boss: Node = $LagartoRobot
...
func _ready() -> void:
	...
	_start_world_flow()
	print("Firipu Adventure — Tarapacá: Espejismos iniciado")
...
func _start_world_flow() -> void:
	...
	if hud.has_method("show_message"):
		hud.show_message("Tarapacá: usa cristal anti-espejismo para ver plataformas reales, registra 4 especies y enfrenta al Lagarto Robot.")
	print("FLOW_START Mundo 15 Tarapacá")

func _on_start_requested() -> void:
	gameplay_started = true
	if player.has_method("set_input_locked"):
		player.set_input_locked(false)
	print("FLOW_GAMEPLAY_START Mundo 15 Tarapacá")
...
func _on_exit_requested() -> void:
	print("FLOW_EXIT_REQUESTED Mundo 15 Tarapacá")
	get_tree().quit(0)
...
func _on_prototype_completed() -> void:
	...
	if global_progress != null:
		global_progress.complete_world("tarapaca")
		global_progress.force_save()
	print("FLOW_VICTORY Mundo 15 Tarapacá")
	_on_save_requested()
...
func _on_boss_defeated() -> void:
	print("FLOW_BOSS_DEFEATED Mundo 15 Tarapacá")
	if hud.has_method("show_message"):
		hud.show_message("¡Lagarto Robot detenido! Los espejismos se disipan. Toma la medalla.")
