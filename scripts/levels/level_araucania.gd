...
# Mundo 3 — La Araucanía (Araucarias del Volcán).
# Reutiliza el flujo del Biobío/Ñuble: 4 especies, jefe robot, medalla.
# Mecánica regional propia: piñón luminoso para trepar araucarias gigantes.

@onready var player: Node = $Firipu
@onready var hud: Node = $HUD
@onready var medal_area: Area3D = $MedalArea
@onready var boss: Node = $GranRanaRobot
...
func _ready() -> void:
	...
	_start_world_flow()
	print("Firipu Adventure — Araucanía: Araucarias del Volcán iniciado")
...
func _start_world_flow() -> void:
	...
	if hud.has_method("show_message"):
		hud.show_message("La Araucanía: usa piñones luminosos para trepar araucarias, registra 4 especies y enfrenta a la Gran Rana Robot.")
	print("FLOW_START Mundo 3 Araucanía")

func _on_start_requested() -> void:
	gameplay_started = true
	if player.has_method("set_input_locked"):
		player.set_input_locked(false)
	print("FLOW_GAMEPLAY_START Mundo 3 Araucanía")
...
func _on_exit_requested() -> void:
	print("FLOW_EXIT_REQUESTED Mundo 3 Araucanía")
	get_tree().quit(0)
...
func _on_prototype_completed() -> void:
	...
	if global_progress != null:
		global_progress.complete_world("araucania")
		global_progress.force_save()
	print("FLOW_VICTORY Mundo 3 Araucanía")
	_on_save_requested()
...
# Yuki detecta el punto débil del guardián en la fase de núcleo.
...
func _on_boss_defeated() -> void:
	print("FLOW_BOSS_DEFEATED Mundo 3 Araucanía")
	if hud.has_method("show_message"):
		hud.show_message("¡Gran Rana Robot reparada! La Araucanía está en calma. Toma la medalla.")
